...
<head>
    <title>Palleon - Javascript Image Editor</title>
    <meta charset="UTF-8">
    ...
    <link href="<?php echo $site_url; ?>/deziner_new/palleon-js/css/select2.css" rel="stylesheet" type="text/css">
    <link href="<?php echo $site_url; ?>/deziner_new/palleon-js/css/spectrum.css" rel="stylesheet" type="text/css">
    <link href="<?php echo $site_url; ?>/deziner_new/palleon-js/css/ruler.css" rel="stylesheet" type="text/css">
    <link href="<?php echo $site_url; ?>/deziner_new/palleon-js/css/toastr.css" rel="stylesheet" type="text/css">
    <link href="<?php echo $site_url; ?>/deziner_new/palleon-js/css/style.css" rel="stylesheet" type="text/css">
    <link id="palleon-theme-link" href="<?php echo $site_url; ?>/deziner_new/palleon-js/css/dark.css" rel="stylesheet" type="text/css">
    <!-- <link id="palleon-theme-link" href="<?php echo $site_url; ?>/deziner_new/palleon-js/css/light.css" rel="stylesheet" type="text/css"> -->
</head>
...
<body id="palleon" class="backend">
    ...
    <div id="palleon-top-bar">
        ...
        <div class="palleon-logo">
            <img class="logo-desktop" src="<?php echo $site_url; ?>/deziner_new/palleon-js/assets/logo.png" />
            <img class="logo-mobile" src="<?php echo $site_url; ?>/deziner_new/palleon-js/assets/logo-small.png" />
        </div>
        <!-- Menu -->
                        ...
                        <div>
                            <div id="palleon-filters" class="palleon-grid two-column">
                                <div class="grid-item" data-keyword="Blog Banner - 2240x1260px" data-category="blog-banners">
                                    ...
                                    <label for="grayscale"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/assets/filters/grayscale.png" /><span>Grayscale</span></label>
                                </div>
                                <div class="grid-item" data-keyword="Blog Banner - 2240x1260px" data-category="blog-banners">
                                    <input type="checkbox" name="palleon-filter" id="sepia" autocomplete="off" class="input-hidden" />
                                    <label for="sepia"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/assets/filters/sepia.png" /><span>Sepia</span></label>
                                </div>
                                <div class="grid-item" data-keyword="Blog Banner - 2240x1260px" data-category="blog-banners">
                                    <input type="checkbox" name="palleon-filter" id="blackwhite" autocomplete="off" class="input-hidden" />
                                    <label for="blackwhite"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/assets/filters/blackwhite.png" /><span>Black/White</span></label>
                                </div>
                                <div class="grid-item" data-keyword="Blog Banner - 2240x1260px" data-category="blog-banners">
                                    <input type="checkbox" name="palleon-filter" id="brownie" autocomplete="off" class="input-hidden" />
                                    <label for="brownie"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/assets/filters/brownie.png" /><span>Brownie</span></label>
                                </div>
                                <div class="grid-item" data-keyword="Blog Banner - 2240x1260px" data-category="blog-banners">
                                    <input type="checkbox" name="palleon-filter" id="vintage" autocomplete="off" class="input-hidden" />
                                    <label for="vintage"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/assets/filters/vintage.png" /><span>Vintage</span></label>
                                </div>
                                <div class="grid-item" data-keyword="Blog Banner - 2240x1260px" data-category="blog-banners">
                                    <input type="checkbox" name="palleon-filter" id="kodachrome" autocomplete="off" class="input-hidden" />
                                    <label for="kodachrome"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/assets/filters/kodachrome.png" /><span>Kodachrome</span></label>
                                </div>
                                <div class="grid-item" data-keyword="Blog Banner - 2240x1260px" data-category="blog-banners">
                                    <input type="checkbox" name="palleon-filter" id="technicolor" autocomplete="off" class="input-hidden" />
                                    <label for="technicolor"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/assets/filters/technicolor.png" /><span>Technicolor</span></label>
                                </div>
                                <div class="grid-item" data-keyword="Blog Banner - 2240x1260px" data-category="blog-banners">
                                    <input type="checkbox" name="palleon-filter" id="polaroid" autocomplete="off" class="input-hidden" />
                                    <label for="polaroid"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/assets/filters/polaroid.png" /><span>Polaroid</span></label>
                                </div>
                                <div class="grid-item" data-keyword="Blog Banner - 2240x1260px" data-category="blog-banners">
                                    <input type="checkbox" name="palleon-filter" id="shift" autocomplete="off" class="input-hidden" />
                                    <label for="shift"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/assets/filters/shift.png" /><span>Shift</span></label>
                                </div>
                                <div class="grid-item" data-keyword="Blog Banner - 2240x1260px" data-category="blog-banners">
                                    <input type="checkbox" name="palleon-filter" id="invert" autocomplete="off" class="input-hidden" />
                                    <label for="invert"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/assets/filters/invert.png" /><span>Invert</span></label>
                                </div>
                                <div class="grid-item" data-keyword="Blog Banner - 2240x1260px" data-category="blog-banners">
                                    <input type="checkbox" name="palleon-filter" id="sharpen" autocomplete="off" class="input-hidden" />
                                    <label for="sharpen"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/assets/filters/sharpen.png" /><span>Sharpen</span></label>
                                </div>
                                <div class="grid-item" data-keyword="Blog Banner - 2240x1260px" data-category="blog-banners">
                                    <input type="checkbox" name="palleon-filter" id="emboss" autocomplete="off" class="input-hidden" />
                                    <label for="emboss"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/assets/filters/emboss.png" /><span>Emboss</span></label>
                                </div>
                                <div class="grid-item" data-keyword="Blog Banner - 2240x1260px" data-category="blog-banners">
                                    <input type="checkbox" name="palleon-filter" id="sobelX" autocomplete="off" class="input-hidden" />
                                    <label for="sobelX"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/assets/filters/sobelX.png" /><span>SobelX</span></label>
                                </div>
                                <div class="grid-item" data-keyword="Blog Banner - 2240x1260px" data-category="blog-banners">
                                    <input type="checkbox" name="palleon-filter" id="sobelY" autocomplete="off" class="input-hidden" />
                                    <label for="sobelY"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/assets/filters/sobelY.png" /><span>SobelY</span></label>
                                </div>
                            </div>
                        </div>
                    </li>
                                    ...
                                    <div id="palleon-frames-grid-grunge" class="palleon-frames-grid paginated" data-perpage="4">
                                        <div class="palleon-frame" data-elsource="files/frames/grunge/1.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/grunge/1.jpg" />
                                            </div>
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/grunge/2.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/grunge/2.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/grunge/3.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/grunge/3.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/grunge/4.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/grunge/4.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/grunge/5.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/grunge/5.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/grunge/6.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/grunge/6.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/grunge/7.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/grunge/7.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/grunge/8.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/grunge/8.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/grunge/9.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/grunge/9.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/grunge/10.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/grunge/10.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/grunge/11.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/grunge/11.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/grunge/12.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/grunge/12.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                ...
                                <div>
                                    <div id="palleon-frames-grid-grunge-square" class="palleon-frames-grid paginated" data-perpage="4">
                                        <div class="palleon-frame" data-elsource="files/frames/grunge-square/1.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/grunge-square/1.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/grunge-square/2.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/grunge-square/2.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/grunge-square/3.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/grunge-square/3.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/grunge-square/4.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/grunge-square/4.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/grunge-square/5.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/grunge-square/5.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/grunge-square/6.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/grunge-square/6.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                ...
                                <div>
                                    <div id="palleon-frames-grid-business" class="palleon-frames-grid paginated" data-perpage="4">
                                        <div class="palleon-frame" data-elsource="files/frames/business/1.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/business/1.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/business/2.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/business/2.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/business/3.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/business/3.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/business/4.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/business/4.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/business/5.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/business/5.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/business/6.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/business/6.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/business/7.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/business/7.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/business/8.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/business/8.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                ...
                                <div>
                                    <div id="palleon-frames-grid-bohemian" class="palleon-frames-grid paginated" data-perpage="4">
                                        <div class="palleon-frame" data-elsource="files/frames/bohemian/1.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/bohemian/1.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/bohemian/2.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/bohemian/2.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/bohemian/3.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/bohemian/3.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/bohemian/4.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/bohemian/4.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/bohemian/5.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/bohemian/5.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/bohemian/6.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/bohemian/6.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/bohemian/7.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/bohemian/7.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/bohemian/8.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/bohemian/8.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/bohemian/9.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/bohemian/9.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/bohemian/10.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/bohemian/10.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                ...
                                <div>
                                    <div id="palleon-frames-grid-abstract" class="palleon-frames-grid paginated" data-perpage="4">
                                        <div class="palleon-frame" data-elsource="files/frames/abstract/1.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/abstract/1.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/abstract/2.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/abstract/2.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/abstract/3.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/abstract/3.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/abstract/4.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/abstract/4.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/abstract/5.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/abstract/5.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/abstract/6.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/abstract/6.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                ...
                                <div>
                                    <div id="palleon-frames-grid-floral" class="palleon-frames-grid paginated" data-perpage="4">
                                        <div class="palleon-frame" data-elsource="files/frames/floral/1.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/floral/1.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/floral/2.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/floral/2.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/floral/3.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/floral/3.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/floral/4.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/floral/4.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/floral/5.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/floral/5.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                ...
                                <div>
                                    <div id="palleon-frames-grid-neon" class="palleon-frames-grid paginated" data-perpage="4">
                                        <div class="palleon-frame" data-elsource="files/frames/neon/1.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/neon/1.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/neon/2.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/neon/2.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/neon/3.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/neon/3.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/neon/4.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/neon/4.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                ...
                                <div>
                                    <div id="palleon-frames-grid-winter" class="palleon-frames-grid paginated" data-perpage="4">
                                        <div class="palleon-frame" data-elsource="files/frames/winter/1.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/winter/1.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/winter/2.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/winter/2.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/winter/3.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/winter/3.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                ...
                                <div>
                                    <div id="palleon-frames-grid-halloween" class="palleon-frames-grid paginated" data-perpage="4">
                                        <div class="palleon-frame" data-elsource="files/frames/halloween/1.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/halloween/1.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/halloween/2.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/halloween/2.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                ...
                                <div>
                                    <div id="palleon-frames-grid-cute" class="palleon-frames-grid paginated" data-perpage="4">
                                        <div class="palleon-frame" data-elsource="files/frames/cute/1.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/cute/1.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/cute/2.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/cute/2.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/cute/3.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/cute/3.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/cute/4.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/cute/4.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/cute/5.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/cute/5.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/cute/6.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/cute/6.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/cute/7.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/cute/7.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                ...
                                <div>
                                    <div id="palleon-frames-grid-watercolor" class="palleon-frames-grid paginated" data-perpage="4">
                                        <div class="palleon-frame" data-elsource="files/frames/watercolor/1.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/watercolor/1.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/watercolor/2.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/watercolor/2.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/watercolor/3.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/watercolor/3.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                ...
                                <div>
                                    <div id="palleon-frames-grid-love" class="palleon-frames-grid paginated" data-perpage="4">
                                        <div class="palleon-frame" data-elsource="files/frames/love/1.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/love/1.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/love/2.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/love/2.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                                ...
                                <div>
                                    <div id="palleon-frames-grid-others" class="palleon-frames-grid paginated" data-perpage="4">
                                        <div class="palleon-frame" data-elsource="files/frames/others/1.svg">
                                            <div class="palleon-img-wrap">
                                                <div class="palleon-img-loader"></div><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/frames/others/1.jpg" />
                                            </div>
                                            <div class="frame-favorite">
                ...
                <div class="palleon-tabs">
                    ...
                    <div id="palleon-overlay-image-mode" class="palleon-tab">
                        ...
                        <div id="palleon-overlay-wrap">
                            <img id="palleon-overlay-preview" src="<?php echo $site_url; ?>/deziner_new/palleon-js/" />
                            ...
                            <li data-keyword="ink-brush-strokes"><a>Ink Brush Strokes<span
                                ...
                                <div>
                                    <div id="palleon-elements-grid-ink-brush-strokes" class="palleon-grid palleon-elements-grid four-column paginated" data-perpage="12">
                                        <div class="palleon-element dark" data-elsource="files/elements/ink-brush-strokes/1.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/ink-brush-strokes/1.svg" />
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/ink-brush-strokes/2.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/ink-brush-strokes/2.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/ink-brush-strokes/3.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/ink-brush-strokes/3.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/ink-brush-strokes/4.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/ink-brush-strokes/4.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/ink-brush-strokes/5.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/ink-brush-strokes/5.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/ink-brush-strokes/6.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/ink-brush-strokes/6.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/ink-brush-strokes/7.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/ink-brush-strokes/7.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/ink-brush-strokes/8.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/ink-brush-strokes/8.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/ink-brush-strokes/9.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/ink-brush-strokes/9.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/ink-brush-strokes/10.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/ink-brush-strokes/10.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/ink-brush-strokes/11.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/ink-brush-strokes/11.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/ink-brush-strokes/12.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/ink-brush-strokes/12.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/ink-brush-strokes/13.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/ink-brush-strokes/13.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/ink-brush-strokes/14.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/ink-brush-strokes/14.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/ink-brush-strokes/15.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/ink-brush-strokes/15.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/ink-brush-strokes/16.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/ink-brush-strokes/16.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/ink-brush-strokes/17.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/ink-brush-strokes/17.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/ink-brush-strokes/18.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/ink-brush-strokes/18.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/ink-brush-strokes/19.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/ink-brush-strokes/19.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/ink-brush-strokes/20.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/ink-brush-strokes/20.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/ink-brush-strokes/21.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/ink-brush-strokes/21.svg" />
                                            <div class="element-favorite">
                            ...
                            <li data-keyword="abstract-shapes"><a>Abstract Shapes<span class="data-count">52</span><span
                                ...
                                <div>
                                    <div id="palleon-elements-grid-abstract-shapes" class="palleon-grid palleon-elements-grid four-column paginated" data-perpage="12">
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/1.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/1.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/2.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/2.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/3.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/3.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/4.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/4.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/5.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/5.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/6.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/6.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/7.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/7.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/8.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/8.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/9.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/9.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/10.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/10.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/11.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/11.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/12.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/12.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/13.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/13.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/14.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/14.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/15.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/15.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/16.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/16.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/17.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/17.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/18.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/18.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/19.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/19.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/20.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/20.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/21.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/21.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/22.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/22.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/23.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/23.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/24.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/24.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/25.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/25.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/26.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/26.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/27.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/27.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/28.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/28.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/29.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/29.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/30.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/30.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/31.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/31.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/32.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/32.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/33.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/33.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/34.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/34.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/35.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/35.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/36.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/36.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/37.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/37.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/38.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/38.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/39.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/39.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/40.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/40.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/41.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/41.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/42.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/42.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/43.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/43.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/44.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/44.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/45.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/45.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/46.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/46.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/47.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/47.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/48.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/48.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/49.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/49.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/50.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/50.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/51.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/51.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/abstract-shapes/52.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/52.svg" />
                                            <div class="element-favorite">
                            ...
                            <li data-keyword="geometric-shapes"><a>Geometric Shapes<span
                                ...
                                <div>
                                    <div id="palleon-elements-grid-geometric-shapes" class="palleon-grid palleon-elements-grid four-column paginated" data-perpage="12">
                                        <div class="palleon-element light" data-elsource="files/elements/geometric-shapes/1.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/geometric-shapes/1.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/geometric-shapes/2.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/geometric-shapes/2.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/geometric-shapes/3.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/geometric-shapes/3.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/geometric-shapes/4.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/geometric-shapes/4.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/geometric-shapes/5.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/geometric-shapes/5.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/geometric-shapes/6.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/geometric-shapes/6.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/geometric-shapes/7.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/geometric-shapes/7.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/geometric-shapes/8.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/geometric-shapes/8.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/geometric-shapes/9.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/geometric-shapes/9.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/geometric-shapes/10.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/geometric-shapes/10.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/geometric-shapes/11.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/geometric-shapes/11.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/geometric-shapes/12.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/geometric-shapes/12.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/geometric-shapes/13.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/geometric-shapes/13.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/geometric-shapes/14.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/geometric-shapes/14.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/geometric-shapes/15.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/geometric-shapes/15.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/geometric-shapes/16.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/geometric-shapes/16.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/geometric-shapes/17.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/geometric-shapes/17.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/geometric-shapes/18.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/geometric-shapes/18.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/geometric-shapes/19.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/geometric-shapes/19.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/geometric-shapes/20.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/geometric-shapes/20.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/geometric-shapes/21.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/geometric-shapes/21.svg" />
                                            <div class="element-favorite">
                            ...
                            <li data-keyword="shape-badges"><a>Shapes &amp; Badges<span
                                ...
                                <div>
                                    <div id="palleon-elements-grid-shape-badges" class="palleon-grid palleon-elements-grid four-column paginated" data-perpage="12">
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/1.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/1.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/2.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/2.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/3.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/3.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/4.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/4.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/5.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/5.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/6.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/6.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/7.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/7.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/8.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/8.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/9.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/9.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/10.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/10.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/11.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/11.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/12.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/12.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/13.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/13.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/14.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/14.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/15.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/15.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/16.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/16.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/17.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/17.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/18.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/18.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/19.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/19.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/20.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/20.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/21.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/21.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/22.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/22.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/23.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/23.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/24.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/24.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/25.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/25.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/26.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/26.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/27.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/27.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/28.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/28.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/29.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/29.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/30.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/30.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/31.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/31.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/32.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/32.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/33.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/33.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/34.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/34.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/35.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/35.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/shape-badges/36.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/shape-badges/36.svg" />
                                            <div class="element-favorite">
                                ...
                                <div>
                                    <div id="palleon-elements-grid-hand-drawn-dividers" class="palleon-grid palleon-elements-grid four-column paginated" data-perpage="12">
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/1.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/1.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/2.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/2.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/3.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/3.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/4.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/4.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/5.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/5.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/6.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/6.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/7.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/7.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/8.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/8.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/9.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/9.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/10.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/10.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/11.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/11.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/12.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/12.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/13.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/13.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/14.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/14.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/15.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/15.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/16.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/16.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/17.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/17.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/18.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/18.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/19.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/19.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/20.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/20.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/21.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/21.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/22.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/22.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/23.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/23.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/24.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/24.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/25.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/25.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/26.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/26.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/27.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/27.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/28.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/28.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/29.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/29.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/hand-drawn-dividers/30.svg" data-loader="no">
                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/hand-drawn-dividers/30.svg" />
                                            <div class="element-favorite">
                            ...
                            <li data-keyword="arrows"><a>Arrows<span class="data-count">31</span><span
                                ...
                                <div>
                                    <div id="palleon-elements-grid-arrows" class="palleon-grid palleon-elements-grid four-column paginated" data-perpage="12">
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/1.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/1.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/2.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/2.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/3.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/3.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/4.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/4.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/5.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/5.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/6.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/6.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/7.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/7.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/8.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/8.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/9.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/9.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/10.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/10.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/11.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/11.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/12.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/12.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/13.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/13.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/14.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/14.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/15.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/15.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/16.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/16.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/17.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/17.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/18.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/18.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/19.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/19.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/20.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/20.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/21.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/21.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/22.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/22.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/23.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/23.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/24.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/24.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/25.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/25.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/26.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/26.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/27.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/27.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/28.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/28.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/29.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/29.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/30.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/30.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/arrows/31.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/arrows/31.svg" />
                                            <div class="element-favorite">
                            ...
                            <li data-keyword="speech-bubbles"><a>Speech Bubbles<span class="data-count">41</span><span
                                ...
                                <div>
                                    <div id="palleon-elements-grid-speech-bubbles" class="palleon-grid palleon-elements-grid four-column paginated" data-perpage="12">
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/1.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/1.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/2.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/2.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/3.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/3.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/4.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/4.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/5.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/5.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/6.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/6.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/7.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/7.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/8.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/8.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/9.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/9.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/10.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/10.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/11.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/11.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/12.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/12.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/13.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/13.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/14.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/14.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/15.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/15.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/16.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/16.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/17.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/17.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/18.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/18.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/19.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/19.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/20.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/20.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/21.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/21.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/22.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/22.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/23.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/23.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/24.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/24.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/25.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/25.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/26.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/26.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/27.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/27.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/28.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/28.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/29.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/29.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/30.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/30.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/31.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/31.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/32.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/32.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/33.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/33.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/34.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/34.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/35.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/35.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/36.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/36.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/37.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/37.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/38.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/38.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/39.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/39.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/40.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/40.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/speech-bubbles/41.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/speech-bubbles/41.svg" />
                                            <div class="element-favorite">
                            ...
                            <li data-keyword="clouds"><a>Clouds<span class="data-count">41</span><span
                                ...
                                <div>
                                    <div id="palleon-elements-grid-clouds" class="palleon-grid palleon-elements-grid four-column paginated" data-perpage="12">
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/1.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/1.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/2.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/2.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/3.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/3.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/4.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/4.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/5.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/5.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/6.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/6.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/7.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/7.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/8.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/8.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/9.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/9.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/10.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/10.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/11.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/11.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/12.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/12.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/13.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/13.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/14.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/14.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/15.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/15.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/16.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/16.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/17.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/17.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/18.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/18.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/19.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/19.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/20.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/20.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/21.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/21.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/22.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/22.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/23.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/23.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/24.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/24.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/25.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/25.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/26.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/26.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/27.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/27.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/28.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/28.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/29.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/29.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/30.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/30.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/31.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/31.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/32.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/32.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/33.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/33.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/34.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/34.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/35.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/35.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/36.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/36.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/37.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/37.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/38.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/38.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/39.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/39.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/40.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/40.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/clouds/41.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/clouds/41.svg" />
                                            <div class="element-favorite">
                            ...
                            <li data-keyword="social-media"><a>Social Media<span class="data-count">55</span><span
                                ...
                                <div>
                                    <div id="palleon-elements-grid-social-media" class="palleon-grid palleon-elements-grid four-column paginated" data-perpage="12">
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/1.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/1.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/2.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/2.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/3.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/3.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/4.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/4.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/5.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/5.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/6.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/6.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/7.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/7.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/8.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/8.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/9.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/9.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/10.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/10.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/11.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/11.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/12.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/12.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/13.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/13.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/14.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/14.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/15.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/15.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/16.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/16.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/17.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/17.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/18.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/18.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/19.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/19.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/20.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/20.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/21.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/21.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/22.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/22.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/23.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/23.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/24.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/24.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/25.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/25.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/26.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/26.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/27.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/27.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/28.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/28.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/29.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/29.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/30.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/30.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/31.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/31.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/32.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/32.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/33.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/33.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/34.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/34.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/35.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/35.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/36.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/36.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/37.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/37.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/38.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/38.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/39.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/39.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/40.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/40.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/41.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/41.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/42.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/42.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/43.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/43.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/44.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/44.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/45.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/45.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/46.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/46.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/47.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/47.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/48.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/48.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/49.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/49.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/50.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/50.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/51.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/51.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/52.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/52.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/53.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/53.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/54.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/54.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/social-media/55.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/social-media/55.svg" />
                                            <div class="element-favorite">
                            ...
                            <li data-keyword="payment"><a>Payment<span class="data-count">80</span><span
                                ...
                                <div>
                                    <div id="palleon-elements-grid-payment" class="palleon-grid palleon-elements-grid four-column paginated" data-perpage="12">
                                        <div class="palleon-element light" data-elsource="files/elements/payment/1.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/1.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/2.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/2.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/3.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/3.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/4.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/4.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/5.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/5.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/6.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/6.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/7.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/7.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/8.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/8.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/9.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/9.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/10.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/10.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/11.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/11.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/12.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/12.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/13.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/13.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/14.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/14.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/15.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/15.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/16.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/16.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/17.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/17.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/18.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/18.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/19.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/19.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/20.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/20.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/21.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/21.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/22.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/22.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/23.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/23.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/24.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/24.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/25.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/25.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/26.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/26.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/27.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/27.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/28.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/28.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/29.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/29.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/30.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/30.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/31.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/31.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/32.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/32.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/33.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/33.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/34.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/34.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/35.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/35.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/36.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/36.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/37.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/37.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/38.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/38.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/39.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/39.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/40.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/40.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/41.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/41.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/42.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/42.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/43.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/43.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/44.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/44.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/45.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/45.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/46.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/46.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/47.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/47.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/48.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/48.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/49.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/49.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/50.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/50.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/51.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/51.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/52.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/52.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/53.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/53.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/54.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/54.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/55.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/55.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/56.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/56.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/57.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/57.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/58.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/58.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/59.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/59.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/60.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/60.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/61.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/61.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/62.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/62.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/63.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/63.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/64.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/64.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/65.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/65.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/66.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/66.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/67.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/67.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/68.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/68.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/69.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/69.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/70.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/70.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/71.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/71.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/72.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/72.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/73.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/73.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/74.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/74.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/75.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/75.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/76.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/76.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/77.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/77.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/78.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/78.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/79.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/79.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/payment/80.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/payment/80.svg" />
                                            <div class="element-favorite">
                            ...
                            <li data-keyword="crypto"><a>Crypto Currency<span class="data-count">56</span><span
                                ...
                                <div>
                                    <div id="palleon-elements-grid-crypto" class="palleon-grid palleon-elements-grid four-column paginated" data-perpage="12">
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/1.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/1.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/2.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/2.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/3.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/3.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/4.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/4.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/5.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/5.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/6.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/6.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/7.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/7.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/8.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/8.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/9.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/9.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/10.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/10.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/11.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/11.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/12.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/12.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/13.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/13.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/14.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/14.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/15.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/15.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/16.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/16.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/17.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/17.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/18.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/18.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/19.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/19.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/20.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/20.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/21.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/21.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/22.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/22.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/23.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/23.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/24.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/24.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/25.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/25.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/26.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/26.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/27.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/27.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/28.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/28.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/29.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/29.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/30.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/30.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/31.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/31.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/32.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/32.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/33.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/33.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/34.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/34.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/35.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/35.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/36.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/36.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/37.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/37.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/38.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/38.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/39.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/39.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/40.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/40.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/41.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/41.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/42.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/42.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/43.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/43.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/44.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/44.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/45.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/45.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/46.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/46.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/47.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/47.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/48.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/48.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/49.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/49.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/50.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/50.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/51.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/51.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/52.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/52.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/53.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/53.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/54.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/54.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/55.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/55.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/crypto/56.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/crypto/56.svg" />
                                            <div class="element-favorite">
                            ...
                            <li data-keyword="avatars"><a>Avatars<span class="data-count">25</span><span
                                ...
                                <div>
                                    <div id="palleon-elements-grid-avatars" class="palleon-grid palleon-elements-grid four-column paginated" data-perpage="12">
                                        <div class="palleon-element light" data-elsource="files/elements/avatars/1.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/avatars/1.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/avatars/2.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/avatars/2.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/avatars/3.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/avatars/3.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/avatars/4.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/avatars/4.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/avatars/5.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/avatars/5.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/avatars/6.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/avatars/6.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/avatars/7.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/avatars/7.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/avatars/8.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/avatars/8.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/avatars/9.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/avatars/9.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/avatars/10.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/avatars/10.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/avatars/11.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/avatars/11.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/avatars/12.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/avatars/12.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/avatars/13.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/avatars/13.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/avatars/14.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/avatars/14.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/avatars/15.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/avatars/15.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/avatars/16.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/avatars/16.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/avatars/17.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/avatars/17.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/avatars/18.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/avatars/18.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/avatars/19.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/avatars/19.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/avatars/20.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/avatars/20.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/avatars/21.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/avatars/21.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/avatars/22.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/avatars/22.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/avatars/23.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/avatars/23.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/avatars/24.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/avatars/24.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/avatars/25.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/avatars/25.svg" />
                                            <div class="element-favorite">
                            ...
                            <li data-keyword="people"><a>People<span class="data-count">43</span><span
                                ...
                                <div>
                                    <div id="palleon-elements-grid-people" class="palleon-grid palleon-elements-grid four-column paginated" data-perpage="12">
                                        <div class="palleon-element light" data-elsource="files/elements/people/1.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/1.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/2.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/2.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/3.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/3.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/4.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/4.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/5.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/5.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/6.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/6.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/7.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/7.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/8.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/8.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/9.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/9.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/10.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/10.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/11.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/11.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/12.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/12.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/13.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/13.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/14.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/14.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/15.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/15.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/16.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/16.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/17.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/17.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/18.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/18.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/19.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/19.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/20.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/20.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/21.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/21.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/22.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/22.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/23.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/23.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/24.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/24.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/25.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/25.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/26.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/26.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/27.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/27.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/28.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/28.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/29.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/29.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/30.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/30.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/31.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/31.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/32.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/32.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/33.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/33.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/34.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/34.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/35.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/35.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/36.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/36.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/37.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/37.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/38.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/38.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/39.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/39.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/40.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/40.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/41.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/41.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/42.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/42.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/people/43.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/people/43.svg" />
                                            <div class="element-favorite">
                            ...
                            <li data-keyword="dividers"><a>Dividers<span class="data-count">25</span><span
                                ...
                                <div>
                                    <div id="palleon-elements-grid-dividers" class="palleon-grid palleon-elements-grid four-column paginated" data-perpage="12">
                                        <div class="palleon-element light" data-elsource="files/elements/dividers/1.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/dividers/1.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/dividers/2.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/dividers/2.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/dividers/3.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/dividers/3.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/dividers/4.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/dividers/4.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/dividers/5.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/dividers/5.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/dividers/6.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/dividers/6.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/dividers/7.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/dividers/7.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/dividers/8.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/dividers/8.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/dividers/9.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/dividers/9.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/dividers/10.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/dividers/10.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/dividers/11.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/dividers/11.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/dividers/12.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/dividers/12.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/dividers/13.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/dividers/13.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/dividers/14.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/dividers/14.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/dividers/15.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/dividers/15.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/dividers/16.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/dividers/16.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/dividers/17.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/dividers/17.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/dividers/18.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/dividers/18.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/dividers/19.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/dividers/19.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/dividers/20.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/dividers/20.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/dividers/21.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/dividers/21.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/dividers/22.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/dividers/22.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/dividers/23.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/dividers/23.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/dividers/24.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/dividers/24.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/dividers/25.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/dividers/25.svg" />
                                            <div class="element-favorite">
                            ...
                            <li data-keyword="trees"><a>Trees<span class="data-count">23</span><span
                                ...
                                <div>
                                    <div id="palleon-elements-grid-trees" class="palleon-grid palleon-elements-grid four-column paginated" data-perpage="12">
                                        <div class="palleon-element light" data-elsource="files/elements/trees/1.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/trees/1.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/trees/2.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/trees/2.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/trees/3.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/trees/3.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/trees/4.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/trees/4.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/trees/5.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/trees/5.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/trees/6.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/trees/6.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/trees/7.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/trees/7.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/trees/8.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/trees/8.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/trees/9.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/trees/9.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/trees/10.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/trees/10.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/trees/11.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/trees/11.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/trees/12.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/trees/12.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/trees/13.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/trees/13.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/trees/14.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/trees/14.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/trees/15.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/trees/15.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/trees/16.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/trees/16.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/trees/17.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/trees/17.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/trees/18.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/trees/18.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/trees/19.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/trees/19.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/trees/20.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/trees/20.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/trees/21.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/trees/21.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/trees/22.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/trees/22.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/trees/23.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/trees/23.svg" />
                                            <div class="element-favorite">
                            ...
                            <li data-keyword="animals"><a>Animals<span class="data-count">48</span><span
                                ...
                                <div>
                                    <div id="palleon-elements-grid-animals" class="palleon-grid palleon-elements-grid four-column paginated" data-perpage="12">
                                        <div class="palleon-element light" data-elsource="files/elements/animals/1.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/1.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/2.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/2.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/3.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/3.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/4.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/4.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/5.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/5.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/6.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/6.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/7.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/7.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/8.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/8.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/9.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/9.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/10.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/10.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/11.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/11.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/12.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/12.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/13.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/13.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/14.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/14.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/15.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/15.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/16.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/16.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/17.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/17.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/18.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/18.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/19.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/19.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/20.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/20.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/21.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/21.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/22.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/22.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/23.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/23.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/24.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/24.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/25.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/25.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/26.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/26.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/27.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/27.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/28.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/28.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/29.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/29.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/30.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/30.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/31.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/31.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/32.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/32.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/33.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/33.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/34.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/34.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/35.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/35.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/36.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/36.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/37.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/37.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/38.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/38.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/39.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/39.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/40.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/40.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/41.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/41.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/42.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/42.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/43.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/43.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/44.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/44.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/45.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/45.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/46.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/46.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/47.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/47.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/animals/48.svg" data-loader="yes"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/animals/48.svg" />
                                            <div class="element-favorite">
                            ...
                            <li data-keyword="vehicles"><a>Vehicles<span class="data-count">9</span><span
                                ...
                                <div>
                                    <div id="palleon-elements-grid-vehicles" class="palleon-grid palleon-elements-grid four-column paginated" data-perpage="12">
                                        <div class="palleon-element light" data-elsource="files/elements/vehicles/1.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/vehicles/1.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/vehicles/2.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/vehicles/2.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/vehicles/3.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/vehicles/3.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/vehicles/4.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/vehicles/4.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/vehicles/5.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/vehicles/5.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/vehicles/6.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/vehicles/6.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/vehicles/7.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/vehicles/7.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/vehicles/8.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/vehicles/8.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/vehicles/9.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/vehicles/9.svg" />
                                            <div class="element-favorite">
                            ...
                            <li data-keyword="quote"><a>Quote<span class="data-count">12</span><span
                                ...
                                <div>
                                    <div id="palleon-elements-grid-quote" class="palleon-grid palleon-elements-grid four-column paginated" data-perpage="12">
                                        <div class="palleon-element light" data-elsource="files/elements/quote/1.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/quote/1.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/quote/2.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/quote/2.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/quote/3.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/quote/3.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/quote/4.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/quote/4.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/quote/5.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/quote/5.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/quote/6.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/quote/6.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/quote/7.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/quote/7.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/quote/8.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/quote/8.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/quote/9.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/quote/9.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/quote/10.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/quote/10.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/quote/11.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/quote/11.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/quote/12.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/quote/12.svg" />
                                            <div class="element-favorite">
                            ...
                            <li data-keyword="weather"><a>Weather<span class="data-count">71</span><span
                                ...
                                <div>
                                    <div id="palleon-elements-grid-weather" class="palleon-grid palleon-elements-grid four-column paginated" data-perpage="12">
                                        <div class="palleon-element light" data-elsource="files/elements/weather/1.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/1.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/2.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/2.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/3.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/3.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/4.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/4.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/5.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/5.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/6.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/6.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/7.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/7.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/8.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/8.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/9.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/9.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/10.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/10.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/11.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/11.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/12.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/12.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/13.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/13.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/14.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/14.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/15.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/15.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/16.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/16.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/17.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/17.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/18.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/18.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/19.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/19.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/20.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/20.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/21.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/21.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/22.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/22.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/23.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/23.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/24.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/24.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/25.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/25.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/26.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/26.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/27.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/27.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/28.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/28.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/29.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/29.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/30.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/30.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/31.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/31.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/32.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/32.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/33.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/33.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/34.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/34.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/35.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/35.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/36.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/36.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/37.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/37.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/38.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/38.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/39.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/39.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/40.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/40.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/41.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/41.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/42.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/42.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/43.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/43.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/44.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/44.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/45.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/45.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/46.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/46.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/47.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/47.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/48.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/48.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/49.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/49.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/50.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/50.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/51.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/51.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/52.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/52.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/53.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/53.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/54.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/54.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/55.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/55.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/56.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/56.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/57.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/57.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/58.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/58.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/59.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/59.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/60.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/60.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/61.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/61.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/62.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/62.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/63.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/63.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/64.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/64.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/65.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/65.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/66.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/66.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/67.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/67.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/68.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/68.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/69.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/69.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/70.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/70.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weather/71.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weather/71.svg" />
                                            <div class="element-favorite">
                            ...
                            <li data-keyword="weapons"><a>Weapons<span class="data-count">25</span><span
                                ...
                                <div>
                                    <div id="palleon-elements-grid-weapons" class="palleon-grid palleon-elements-grid four-column paginated" data-perpage="12">
                                        <div class="palleon-element light" data-elsource="files/elements/weapons/1.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weapons/1.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weapons/2.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weapons/2.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weapons/3.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weapons/3.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weapons/4.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weapons/4.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weapons/5.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weapons/5.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weapons/6.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weapons/6.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weapons/7.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weapons/7.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weapons/8.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weapons/8.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weapons/9.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weapons/9.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weapons/10.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weapons/10.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weapons/11.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weapons/11.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weapons/12.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weapons/12.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weapons/13.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weapons/13.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weapons/14.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weapons/14.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weapons/15.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weapons/15.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weapons/16.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weapons/16.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weapons/17.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weapons/17.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weapons/18.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weapons/18.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weapons/19.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weapons/19.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weapons/20.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weapons/20.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weapons/21.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weapons/21.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weapons/22.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weapons/22.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weapons/23.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weapons/23.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weapons/24.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weapons/24.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element light" data-elsource="files/elements/weapons/25.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/weapons/25.svg" />
                                            <div class="element-favorite">
                            ...
                            <li data-keyword="gifts"><a>Gifts<span class="data-count">16</span><span
                                ...
                                <div>
                                    <div id="palleon-elements-grid-gifts" class="palleon-grid palleon-elements-grid four-column paginated" data-perpage="12">
                                        <div class="palleon-element dark" data-elsource="files/elements/gifts/1.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/gifts/1.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/gifts/2.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/gifts/2.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/gifts/3.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/gifts/3.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/gifts/4.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/gifts/4.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/gifts/5.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/gifts/5.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/gifts/6.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/gifts/6.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/gifts/7.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/gifts/7.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/gifts/8.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/gifts/8.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/gifts/9.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/gifts/9.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/gifts/10.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/gifts/10.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/gifts/11.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/gifts/11.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/gifts/12.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/gifts/12.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/gifts/13.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/gifts/13.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/gifts/14.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/gifts/14.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/gifts/15.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/gifts/15.svg" />
                                            <div class="element-favorite">
                                        ...
                                        <div class="palleon-element dark" data-elsource="files/elements/gifts/16.svg" data-loader="no"><img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/gifts/16.svg" />
                                            <div class="element-favorite">
            ...
            <div id="palleon-ruler" class="palleon-inner-wrap">
                ...
                <div id="palleon-content" class="">
                    ...
                    <div id="palleon-canvas-img-wrap">
                        <img id="palleon-canvas-img" src="<?php echo $site_url; ?>/deziner_new/palleon-js/" data-filename="" data-template="" />
                        <!-- 
                            Don't remove img element! To open the editor with a default image, you can update it like the following; 
                            <img id="palleon-canvas-img" src="<?php echo $site_url; ?>/deziner_new/palleon-js/assets/placeholder-big.jpg" data-filename="placeholder" data-template="" />
                            To open the editor with a default template, you can update it like the following; 
                            <img id="palleon-canvas-img" src="<?php echo $site_url; ?>/deziner_new/palleon-js/" data-filename="template" data-template="files/templates/json/25.json" /> 
                        -->
                    </div>
                                            ...
                                            <div id="palleon-templates-grid" class="palleon-grid template-grid template-selection paginated" data-perpage="21">
                                                <div class="grid-item" data-keyword="Blog Banner - 2240x1260px" data-category="blog-banners">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/25.json">
                                                        <div class="palleon-img-wrap">
                                                            ...
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/25.jpg" title="Blog Banner - 2240x1260px" />
                                                        </div>
                                                ...
                                                <div class="grid-item" data-keyword="Modern Collage - 2 Photos - 2000x1300px" data-category="collage">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/20.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/20.jpg" title="Modern Collage - 2 Photos - 2000x1300px" />
                                                        </div>
                                                ...
                                                <div class="grid-item" data-keyword="Youtube Video Thumbnail - 1280x720px" data-category="youtube-thumbnail">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/15.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/15.jpg" title="Youtube Video Thumbnail - 1280x720px" />
                                                        </div>
                                                ...
                                                <div class="grid-item" data-keyword="Black Friday Banner - Leaderboard - 728x90px" data-category="leaderboard">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/23.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/23.jpg" title="Black Friday Banner - Leaderboard - 728x90px" />
                                                        </div>
                                                ...
                                                <div class="grid-item" data-keyword="Trending Music Video - Youtube Thumbnail - 1280x720px" data-category="youtube-thumbnail">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/14.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/14.jpg" title="Trending Music Video - Youtube Thumbnail - 1280x720px" />
                                                        </div>
                                                ...
                                                <div class="grid-item" data-keyword="Kids Style Collage - 2 Photos - 2000x2000px" data-category="collage">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/18.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/18.jpg" title="Kids Style Collage - 2 Photos - 2000x2000px" />
                                                        </div>
                                                ...
                                                <div class="grid-item" data-keyword="Cafe Banner - Billboard - 970x250px" data-category="billboard">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/28.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/28.jpg" title="Cafe Banner - Billboard - 970x250px" />
                                                        </div>
                                                ...
                                                <div class="grid-item" data-keyword="Beauty - Leaderboard - 728x90px" data-category="leaderboard">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/36.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/36.jpg" title="Beauty - Leaderboard - 728x90px" />
                                                        </div>
                                                ...
                                                <div class="grid-item" data-keyword="Digital Agency Banner - Leaderboard - 728x90px" data-category="leaderboard">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/8.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/8.jpg" title="Digital Agency Banner - Leaderboard - 728x90px" />
                                                        </div>
                                                ...
                                                <div class="grid-item" data-keyword="Happy Birthday - Facebook Post - 940x788px" data-category="facebook-post">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/29.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/29.jpg" title="Happy Birthday - Facebook Post - 940x788px" />
                                                        </div>
                                                ...
                                                <div class="grid-item" data-keyword="Blog Banner - 2240x1260px" data-category="blog-banners">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/27.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/27.jpg" title="Blog Banner - 2240x1260px" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc">Blog Banner - 2240x1260px</div>
                                                    </div>
                                                </div>
                                                <div class="grid-item" data-keyword="Collage - 3 Photos - 2000x2000px" data-category="collage">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/16.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/16.jpg" title="Collage - 3 Photos - 2000x2000px" />
                                                        </div>
                                                ...
                                                <div class="grid-item" data-keyword="Banner - Twitter Post - 1600x900px" data-category="twitter-post">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/39.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/39.jpg" title="Banner - Twitter Post - 1600x900px" />
                                                        </div>
                                                ...
                                                <div class="grid-item" data-keyword="Christmas Sale - Instagram Post - Square - 1080x1080px" data-category="instagram-post">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/12.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/12.jpg" title="Christmas Sale - Instagram Post - Square - 1080x1080px" />
                                                        </div>
                                                ...
                                                <div class="grid-item" data-keyword="Quote - Instagram Post - 1080x1080px" data-category="instagram-post">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/32.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/32.jpg" title="Quote - Instagram Post - 1080x1080px" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc">
                                                ...
                                                <div class="grid-item" data-keyword="Modern Collage - 3 Photos - 2000x2000px" data-category="collage">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/22.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/22.jpg" title="Modern Collage - 3 Photos - 2000x2000px" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc">
                                                ...
                                                <div class="grid-item" data-keyword="Quote - 900x600px" data-category="quote">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/4.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/4.jpg" title="Quote - 900x600px" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc">
                                                            Quote - 900x600px 
                                                        </div>
                                                ...
                                                <div class="grid-item" data-keyword="Blog Banner - 2240x1260px" data-category="blog-banners">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/26.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/26.jpg" title="Blog Banner - 2240x1260px" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc">
                                                ...
                                                <div class="grid-item" data-keyword="Sale Banner - Instagram Post - Discount Offer - Square - 1080x1080px " data-category="instagram-post">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/1.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/1.jpg" title="Sale Banner - Instagram Post - Discount Offer - Square - 1080x1080px" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc">
                                                ...
                                                <div class="grid-item" data-keyword="Summer Sale - Facebook Ad - 1200x628px " data-category="facebook-ads">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/10.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/10.jpg" title="Summer Sale - Facebook Ad - 1200x628px" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc">
                                                ...
                                                <div class="grid-item" data-keyword="Kids Style Collage - 2 Photos - 2000x1300px " data-category="collage">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/17.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/17.jpg" title="Kids Style Collage - 2 Photos - 2000x1300px" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc">
                                                ...
                                                <div class="grid-item" data-keyword="Happy Childrens Day - Facebook Post - 940x788px" data-category="facebook-post">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/33.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/33.jpg" title="Happy Childrens Day - Facebook Post - 940x788px" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc">
                                                ...
                                                <div class="grid-item" data-keyword="Fitness Banner - Medium Rectangle - 300x250px " data-category="banner-ads">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/6.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/6.jpg" title="Fitness Banner - Medium Rectangle - 300x250px" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc">
                                                ...
                                                <div class="grid-item" data-keyword="Quote - Twitter Post - 1600x900px " data-category="quote">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/37.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/37.jpg" title="Quote - Twitter Post - 1600x900px" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc">
                                                ...
                                                <div class="grid-item" data-keyword="Real Estate - Facebook Post - 940x788px " data-category="facebook-post">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/41.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/41.jpg" title="Real Estate - Facebook Post - 940x788px" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc">
                                                ...
                                                <div class="grid-item" data-keyword="Sale Banner - Facebook Ad - 1200x628px " data-category="facebook-ads">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/11.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/11.jpg" title="Sale Banner - Facebook Ad - 1200x628px" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc">
                                                ...
                                                <div class="grid-item" data-keyword="Collage - 5 Photos - 2000x1000px" data-category="collage">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/21.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/21.jpg" title="Collage - 5 Photos - 2000x1000px" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc">
                                                ...
                                                <div class="grid-item" data-keyword="Fitness Banner - Medium Rectangle - 300x250px" data-category="banner-ads">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/7.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/7.jpg" title="Fitness Banner - Medium Rectangle - 300x250px" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc">
                                                            Fitness Banner - Medium Rectangle - 300x250px 
                                                        </div>
                                                ...
                                                <div class="grid-item" data-keyword="Quote - 800x600px" data-category="quote">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/3.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/3.jpg" title="Quote - 800x600px" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc">
                                                            Quote - 800x600px 
                                                        </div>
                                                ...
                                                <div class="grid-item" data-keyword="Business Banner - Instagram Post - 1080x1080px" data-category="instagram-post">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/42.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/42.jpg" title="Business Banner - Instagram Post - 1080x1080px" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc">
                                                ...
                                                <div class="grid-item" data-keyword="Business Facebook Post - 940x788px " data-category="facebook-post">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/13.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/13.jpg" title="Business Facebook Post - 940x788px" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc">
                                                ...
                                                <div class="grid-item" data-keyword="App Banner - 2000x1300px" data-category="banner-ads">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/5.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/5.jpg" title="App Banner - 2000x1300px" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc">
                                                ...
                                                <div class="grid-item" data-keyword="Business Blog Banner - 2240x1260px" data-category="blog-banners">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/34.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/34.jpg" title="Business Blog Banner - 2240x1260px" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc">
                                                ...
                                                <div class="grid-item" data-keyword="Valentines Day - Instagram Post - Square - 1080x1080px" data-category="instagram-post">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/2.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/2.jpg" title="Valentines Day - Instagram Post - Square - 1080x1080px" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc">
                                                ...
                                                <div class="grid-item" data-keyword="Blog Banner - 2240x1260px" data-category="blog-banners">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/30.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/30.jpg" title="Blog Banner - 2240x1260px" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc">
                                                            Blog Banner - 2240x1260px 
                                                        </div>
                                                ...
                                                <div class="grid-item" data-keyword="Stylish Collage - 3 Photos - 2000x2000px " data-category="collage">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/19.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/19.jpg" title="Stylish Collage - 3 Photos - 2000x2000px" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc">
                                                ...
                                                <div class="grid-item" data-keyword="Pet Shop Banner - Billboard - 970x250px" data-category="billboard">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/9.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/9.jpg" title="Pet Shop Banner - Billboard - 970x250px" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc">
                                                ...
                                                <div class="grid-item" data-keyword="Blog Banner - 2240x1260px" data-category="blog-banners">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/35.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/35.jpg" title="Blog Banner - 2240x1260px" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc">
                                                            Blog Banner - 2240x1260px 
                                                        </div>
                                                ...
                                                <div class="grid-item" data-keyword="Christmas Banner - Leaderboard - 728x90px " data-category="leaderboard">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/24.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/24.jpg" title="Christmas Banner - Leaderboard - 728x90px" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc">
                                                ...
                                                <div class="grid-item" data-keyword="Blog Banner - 2240x1260px" data-category="blog-banners">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/38.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/38.jpg" title="Blog Banner - 2240x1260px" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc">
                                                            Blog Banner - 2240x1260px 
                                                        </div>
                                                ...
                                                <div class="grid-item" data-keyword="Fashion Banner - Facebook Ad - 1200x628px " data-category="facebook-ads">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/40.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/40.jpg" title="Fashion Banner - Facebook Ad - 1200x628px" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc">
                                                ...
                                                <div class="grid-item" data-keyword="Quote - Twitter Post - 1600x900px " data-category="twitter-post">
                                                    ...
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="files/templates/json/31.json">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/templates/img/31.jpg" title="Quote - Twitter Post - 1600x900px" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc">
                                                            Quote - Twitter Post - 1600x900px 
                                                        </div>
                        ...
                        <div id="palleon-library-my" class="palleon-grid media-library-grid paginated" data-perpage="18">
                            <div class="palleon-masonry-item" data-keyword="lorem kotem">
                                ...
                                <div class="palleon-masonry-item-inner">
                                    <div class="palleon-img-wrap">
                                        <div class="palleon-img-loader"></div>
                                        <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/assets/placeholder.jpg" data-full="<?php echo $site_url; ?>/deziner_new/palleon-js/assets/placeholder-big.jpg" data-filename="Lorem" title="Lorem ipsum dolor" />
                                    </div>
                        ...
                        <div id="palleon-library-all" class="palleon-grid media-library-grid paginated" data-perpage="18">
                            <div class="palleon-masonry-item" data-keyword="lorem">
                                ...
                                <div class="palleon-masonry-item-inner">
                                    <div class="palleon-img-wrap">
                                        <div class="palleon-img-loader"></div>
                                        <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/assets/placeholder.jpg" data-full="<?php echo $site_url; ?>/deziner_new/palleon-js/assets/placeholder-big.jpg" data-filename="Lorem" title="Lorem"
                                        />
                                    </div>
                                    <div class="palleon-masonry-item-desc">Lorem ipsum dolor</div>
                                </div>
                        ...
                        <div id="palleon-svg-library-my" class="palleon-grid svg-library-grid paginated" data-perpage="18">
                            <div class="palleon-masonry-item" data-keyword="Abstract Shape">
                                ...
                                <div class="palleon-masonry-item-inner">
                                    <div class="palleon-img-wrap">
                                        <div class="palleon-img-loader"></div>
                                        <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/1.svg" data-full="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/1.svg" data-filename="abstract-shape" title="Abstract Shape"
                                        />
                                    </div>
                            ...
                            <div class="palleon-masonry-item" data-keyword="another shape">
                                ...
                                <div class="palleon-masonry-item-inner">
                                    <div class="palleon-img-wrap">
                                        <div class="palleon-img-loader"></div>
                                        <img class="lazy" data-src="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/2.svg" data-full="<?php echo $site_url; ?>/deziner_new/palleon-js/files/elements/abstract-shapes/2.svg" data-filename="another-shape" title="Another Shape"
                                        />
                                    </div>
    ...
    <!-- Modal History END -->
    <!-- Scripts -->
    <script src="<?php echo $site_url; ?>/deziner_new/palleon-js/js/jquery.min.js" ></script>
    <script src="<?php echo $site_url; ?>/deziner_new/palleon-js/js/jquery-ui.min.js"></script>
    <script src="<?php echo $site_url; ?>/deziner_new/palleon-js/js/fabric.min.js"></script>
    <script src="<?php echo $site_url; ?>/deziner_new/palleon-js/js/plugins.min.js"></script>
    <script src="<?php echo $site_url; ?>/deziner_new/palleon-js/js/palleon.min.js"></script>
     <!-- Canvas Ruler -->
    ...
    <script src="<?php echo $site_url; ?>/deziner_new/palleon-js/js/custom.js"></script>
    <!-- Translation Strings -->
    <script>
        /* <![CDATA[ */
        var palleonParams = {
