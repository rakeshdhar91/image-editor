<?php session_start(); 
    include($_SERVER['DOCUMENT_ROOT'].'/DataBase/config.php'); 
        ...
        $deziner_allow = $defaultPlanData['deziner']['status'];

    /*if(empty($deziner_allow)){
    
     $uclass="tab-blur";
    
    echo '<a href="javascript:void(0)"  style="display:none" upgrade-type="permission" data-type="content_curation"  class="col cursor-pointer upgrade-premission"></a>';
    }*/
    ...
    if(isset($_GET['token']) && !empty($_GET['token'])){
         $token = $_GET['token'];
        $sql = "SELECT json_path,template_name,sub_id FROM `vd_deziner_image_uploads` WHERE token='$token'";
        $qry = mysqli_query($con,$sql); 
        $rew = mysqli_fetch_array($qry);
        $file_url = $rew['json_path'];
            $template_name = $rew['template_name'];
            $template_sub_id = $rew['sub_id'];
    ...
    if(isset($_GET['img_data']) && !empty($_GET['img_data'])){  
               $img_tokeb = $_GET['img_data'];
               $img_tokeb = "https://app.viraldashboard.io/deziner_new/design/cron_image/$img_tokeb.jpg";  
                $ss = $img_tokeb;
                $ff = 'placeholder';
                $tt =  '' ;
    }   
...
<body id="palleon" class="backend">
    ...
    <div id="palleon-top-bar">
        ...
        <div class="palleon-logo">
            ...
            <img class="logo-desktop" src="https://app.viraldashboard.io/images/vd-logo-v4.png" style="width: 220px;" />
            <img class="logo-mobile" src="https://app.viraldashboard.io/images/vd-logo-v4.png" style="width: 220px;" />
            </a>
        </div>
        <!-- Menu -->
    ...
    <div id="palleon-icon-menu">
        <button id="palleon-btn-Similar" type="button" class="palleon-icon-menu-btn active" data-target="#palleon-Similar">
            <span class="material-icons">grid_view</span><span class="palleon-icon-menu-title">Design</span>
        </button> 
    ...
    <div id="palleon-icon-panel">
        <div id="palleon-icon-panel-inner">
            ...
            <div id="palleon-Similar" class="palleon-icon-panel-content"> 
                 <div id="palleon-all-templates" class="palleon-tab ">
                                    ...
                                    <div class="palleon-templates-content">
                                        <div class="palleon-grid-wrap">
                                            <div id="palleon-all-templates-noimg" class="notice notice-warning d-none">Nothing found.</div>
                                                <div id="palleon-templates-grid" class="palleon-grid template-grid template-selection paginated" data-perpage="8">
                                               <?php 
                                                      $template_sub_id = $rew['sub_id'];
                                                      if(isset($_GET['sub_id']) && !empty($_GET['sub_id'])  ){
                                                          $template_sub_id = $_GET['sub_id'] ;
                                                      }
                                                       $sqld = "SELECT * FROM `vd_deziner_image_uploads` WHERE sub_id='$template_sub_id'";
                                                       $qryd = mysqli_query($con,$sqld); 
                                                 while($rew123 = mysqli_fetch_array($qryd)){
                                               ?>  
                                                <div class="grid-item" data-keyword="<?= $rew123['template_name'] ?>" data-category="">
                                                     
                                                    <div class="palleon-masonry-item-inner palleon-select-template" data-json="<?= $rew123['json_path'] ?>">
                                                        <div class="palleon-img-wrap">
                                                            <div class="palleon-img-loader"></div>
                                                            <img class="lazy" data-src="<?= $rew123['img_path'] ?>" title="<?= $rew123['template_name'] ?>" />
                                                        </div>
                                                        <div class="palleon-masonry-item-desc"><?= $rew123['template_name'] ?></div>
                                                    </div>
                                                </div>
                                                <?php } ?>
            ...
            <!-- Adjust START -->
            <div id="palleon-adjust" class="palleon-icon-panel-content panel-hide">
                ...
                <div class="palleon-tabs">
                                ...
                                <div>
                                    <div id="palleon-frames-grid-grunge" class="palleon-frames-grid paginated" data-perpage="4">
                                        ...
                                        <div class="palleon-frame" data-elsource="files/frames/grunge/2.svg">
                                            ...
                                            <div class="frame-favorite">
                                                <button type="button" class="palleon-btn-simple star favorited" data-frameid="grunge/2"><span class="material-icons">star_border</span></button>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    <div id="palleon-frames-grid-bohemian" class="palleon-frames-grid paginated" data-perpage="4">
                                        <div class="palleon-frame" data-elsource="files/frames/bohemian/1.svg">
                                            ...
                                            <div class="frame-favorite">
                                                <button type="button" class="palleon-btn-simple star favorited" data-frameid="bohemian/1"><span class="material-icons">star_border</span></button>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    <div id="palleon-frames-grid-abstract" class="palleon-frames-grid paginated" data-perpage="4">
                                        <div class="palleon-frame" data-elsource="files/frames/abstract/1.svg">
                                            ...
                                            <div class="frame-favorite">
                                                <button type="button" class="palleon-btn-simple star favorited" data-frameid="abstract/1"><span class="material-icons">star_border</span></button>
                                            </div>
                                        </div>
                    ...
                    <div id="palleon-frame-favorites" class="palleon-tab">
                        <div class="palleon-frames-grid">
                            <?php   $sio = "select frame from wl_deziner_favourite where type = 1 and user_id = '$user_id'";
                                    $wert =  mysqli_query($con,$sio);
                                    while($res_f = mysqli_fetch_array($wert)){
                                    $frame_a = $res_f['frame'];?>

                            <div class="palleon-frame" data-elsource="files/frames/<?=$frame_a?>.svg">
                                <div class="palleon-img-wrap">
                                    <div class="palleon-img-loader"></div><img class="lazy" data-src="files/frames/<?=$frame_a?>.jpg" />
                                </div>
                                <div class="frame-favorite">
                                    <button type="button" class="palleon-btn-simple star favorited" data-frameid="<?=$frame_a?>"><span class="material-icons">star</span></button>
                                </div>
                            </div>
                            <?php } ?> 
                        </div>
                ...
                <div class="palleon-tabs">
                    ...
                    <div id="palleon-my-favorites" class="palleon-tab">
                        <div class="palleon-grid palleon-elements-grid five-column">
                             <?php   $sioe = "select element from wl_deziner_favourite where type = 2 and user_id = '$user_id'";
                                     $werte =  mysqli_query($con,$sioe);
                                    while($res_fw = mysqli_fetch_array($werte)){
                                        $element_a = $res_fw['element'];?>
                             <div class="palleon-element dark" data-elsource="files/elements/<?= $element_a ?>.svg" data-loader="no" style="min-height: auto;"><img class="lazy entered loaded" data-src="files/elements/ink-brush-strokes/6.svg" data-ll-status="loaded" src="files/elements/ink-brush-strokes/6.svg">
                                <div class="element-favorite">
                                    <button type="button" class="palleon-btn-simple star " data-elementid="<?= $element_a ?>"><span class="material-icons">star</span></button>
                                </div>
                            </div>
                            <?php }?>
                        </div>
            ...
            <div id="palleon-ruler" class="palleon-inner-wrap">
                ...
                <div id="palleon-content" class="">
                    ...
                    <div id="palleon-canvas-img-wrap">
                        <!--<img id="palleon-canvas-img" src="" data-filename="" data-template="" />-->
                          
                           <img id="palleon-canvas-img" src="<?= $ss ?>" data-filename="<?= $ff ?>" data-template="<?= $tt ?>" /> 
                            ...
                            <div class="palleon-tabs">
                                ...
                                <div id="palleon-all-templates" class="palleon-tab active">
                                    ...
                                    <div class="palleon-templates-content">
                                        <div class="palleon-grid-wrap">
                                            <div id="palleon-all-templates-noimg" class="notice notice-warning d-none">Nothing found.</div>
                                            <div id="palleon-templates-grids" class="palleon-grid template-grid template-selection paginated" data-perpage="21">
                                                <div class="grid-item" data-keyword="Blog Banner - 2240x1260px" data-category="blog-banners">
            ...
            <div class="palleon-modal-inner">
                <div class="palleon-tabs">
                    ...
                    <div id="modal-tab-save" class="palleon-tab active">
                        ...
                        <!--    </div>-->
                        <!--</div>-->
                        <div id="palleon-save-as-json" style="border:0;margin: 0;padding: 0;">
                            <div class="">
                    ...
                    <div id="modal-tab-download" class="palleon-tab ">
                        <div id="palleon-download-as-img">
                            ...
                            <div class="palleon-block-33" style="margin-bottom:15px;">
                                <div>
                                    <label>DPI</label>
    ...
    <input type="hidden" id="token_" value="<?= $token ?>">
    <input type="hidden" id="cat_id" value="<?= $_GET['cat_id']; ?>">
    <input type="hidden" id="sub_id" value="<?= $_GET['sub_id']; ?>">
    <!-- Modal History END -->
    <!-- Scripts -->
...
<?php
  $canva_height = $_GET['height'];
  $canva_width  = $_GET['width'];
  $canva_colorPicker  = $_GET['colorPicker'];
//   dd($canva_colorPicker);
   if(isset($canva_height) && !empty($canva_height)){?>
       <script>
       setTimeout(function(){ 
            document.getElementById('palleon-canvas-height').value = <?= $canva_height ?>;
            document.getElementById('palleon-canvas-width').value = <?= $canva_width ?>;
            document.getElementById('palleon-canvas-color').value = '<?= $canva_colorPicker ?>';
            document.getElementById('palleon-canvas-create').click();
            // document.getElementById('palleon-canvas-color').click();
            }, 1000);
